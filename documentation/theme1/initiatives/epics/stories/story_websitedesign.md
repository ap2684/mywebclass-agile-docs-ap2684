As a website designer, I want to create a basic web template that is easy to find using search engines, so that users can quickly and easily find and use the website.
